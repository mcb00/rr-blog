...
TODO image of a hammer
> "I suppose it is tempting, if the only tool you have is a hammer, to treat everything as if it were a nail."
Abraham Maslow

Effectively we're taking that decision optimization problem $ \underset{x} \text{argmax} f(x) $
...
To help build some intuition for why optimization based on predictive models can fail, let's work with a concrete example.
...
TODO table showing average retention for off vs no offer 

Wow, offers are associated with lower retention in the historical data.
Our promos must be pretty terrible. 
...
$$ \underset{x} \text{argmax} f(x) = no offer$$
